...
try:
    ...
    from models import User, Project, SysModel, SysField
    ...
    from modules.builder.models import create_system_archetypes
    from marketplace.models import create_default_categories
