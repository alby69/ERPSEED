...
from core.schemas.schemas import SysChartSchema, SysDashboardSchema, ChartLibraryConfigSchema
from core.utils.utils import get_table_object
from modules.dynamic_api.service import get_dynamic_api_service as DynamicApiService
from core.services.generic_service import generic_service
from core.utils.utils import paginate, serialize_value
from modules.analytics.service import get_analytics_service
...
def get_analytics_svc():
    from modules.analytics.service.api import AnalyticsService
