...
from modules.ai.context import get_project_context, get_conversation_context
from modules.ai.tool_registry import tool_registry
from modules.ai.adapters import get_adapter, LLMAdapter
...
class AIService:
    ...
    def _register_tool_handlers(self):
        ...
        from modules.ai.tool_executors import (
            workflow_executor,
            hook_executor,
...
What would you like me to create or modify? I'll analyze the project context and help you build the best solution."""
    ...
    def save_conversation(
        ...
        from modules.ai.application.commands.ai_commands import SaveConversationCommand
    ...
    def _handle_register_business_rule(self, args: Dict, context: Dict) -> Dict:
        ...
        from modules.ai.tool_executors import hook_executor
    ...
    def _handle_create_scheduled_task(self, args: Dict, context: Dict) -> Dict:
        ...
        from modules.ai.tool_executors import scheduled_task_executor
    ...
    def _handle_setup_notification(self, args: Dict, context: Dict) -> Dict:
        ...
        from modules.ai.tool_executors import notification_executor
    ...
    def _handle_generate_test_suite(self, args: Dict, context: Dict) -> Dict:
        ...
        from modules.ai.test_generator import ai_test_generator
