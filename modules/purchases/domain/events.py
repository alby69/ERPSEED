...
class PurchaseOrderCreatedEvent(DomainEvent):
    def __init__(self, orderId: int, order_data: Dict[str, Any], tenant_id: int):
        super().__init__("purchase_order.created", {"orderId": orderId, "order_number": order_data.get("number"),
...
class PurchaseOrderUpdatedEvent(DomainEvent):
    def __init__(self, orderId: int, old_data: Dict, new_data: Dict, tenant_id: int):
        super().__init__("purchase_order.updated", {"orderId": orderId, "old_status": old_data.get("status"),
...
class PurchaseOrderConfirmedEvent(DomainEvent):
    def __init__(self, orderId: int, order_data: Dict, tenant_id: int):
        super().__init__("purchase_order.confirmed", {"orderId": orderId, "order_number": order_data.get("number"),
...
class PurchaseOrderReceivedEvent(DomainEvent):
    def __init__(self, orderId: int, order_data: Dict, tenant_id: int):
        super().__init__("purchase_order.received", {"orderId": orderId, "order_number": order_data.get("number"),
            "total_amount": order_data.get("total_amount"), "tenant_id": tenant_id})
...
class PurchaseOrderCancelledEvent(DomainEvent):
    def __init__(self, orderId: int, order_data: Dict, tenant_id: int):
        super().__init__("purchase_order.cancelled", {"orderId": orderId, "order_number": order_data.get("number"),
            "tenant_id": tenant_id})
