...
from core.schemas.schemas import BaseSchema
from core.services.generic_service import generic_service
from core.utils.utils import paginate, apply_filters, apply_sorting
...
class JournalEntryList(MethodView):
    ...
    def post(self, entry_instance, tenant_id):
        ...
        try:
            from webhook_triggers import on_journal_entry_created
...
class InvoiceList(MethodView):
    ...
    def post(self, invoice_instance, tenant_id):
        ...
        try:
            from webhook_triggers import on_invoice_created
