...
IMPORT_MAPPINGS = {
    ...
    "from backend.projects import": "from backend.api.projects import",
    "from backend.dashboard import": "from backend.api.dashboard import",
    "from backend.analytics import": "from backend.api.analytics import",
    "from backend.dynamic_api import": "from backend.api.dynamic import",
    "from backend.template_api import": "from backend.api.templates import",
    "from backend.visual_builder_api import": "from backend.api.visual_builder import",
    "from backend.versioning_api import": "from backend.api.versioning import",
    "from backend.debugging_api import": "from backend.api.debugging import",
    "from backend.gdo_reconciliation_api import": "from backend.api.gdo import",
