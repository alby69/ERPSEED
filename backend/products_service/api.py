...
from backend.products_service.application.commands import (
...
from backend.products_service.application.handlers import (
...
def execute(command_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Usage from CLI:
        python -c "
        import json
        from backend.products_service.api import execute
