"""
Domain Models for Products Service.

These are pure Python dataclasses that represent the domain concepts.
They are independent from SQLAlchemy models (infrastructure layer).
"""
...
class Product:
    ...
    def validate(self) -> tuple[bool, list[str]]:
        """Validate the product data. Returns (is_valid, errors)."""
        errors = []
