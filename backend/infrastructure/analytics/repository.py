...
class ChartRepository:
    ...
    def _to_dict(self, chart) -> Dict[str, Any]:
        return {"id": chart.id, "project_id": chart.project_id, "name": chart.name, "chart_type": chart.chart_type,
            "config": chart.config, "model_id": chart.model_id,
...
class ChartLibraryRepository:
    ...
    def _to_dict(self, item) -> Dict[str, Any]:
        return {"id": item.id, "library_name": item.library_name,
            "display_name": getattr(item, 'display_name', item.library_name),
            "description": getattr(item, 'description', ''), "is_default": item.is_default,
