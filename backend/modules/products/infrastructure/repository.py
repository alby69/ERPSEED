...
class ProductRepository:
    ...
    def _get_model_class(self):
        """Get the Product model class lazily."""
    ...
    def update(self, product_id: int, tenant_id: int, changes: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        new_data = self._to_dict(product)
    ...
    def check_dependencies(self, product_id: int, tenant_id: int) -> Dict[str, Any]:
        """Check if product has dependencies (orders, stock)."""
        from backend.models import SalesOrderLine, PurchaseOrderLine
        ...
        return {
            "has_dependencies": sales_lines > 0 or purchase_lines > 0 or has_stock,
            "sales_order_lines": sales_lines,
            "purchase_order_lines": purchase_lines,
            "has_stock_records": has_stock,
        }
