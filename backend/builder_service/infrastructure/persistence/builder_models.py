...
These models are used by the builder_service infrastructure layer.
"""
...
class Block(db.Model):
    ...
    def get_params(self) -> dict:
        """Get effective params (template params merged with overrides)."""
    ...
    def is_instance(self) -> bool:
        """Check if this block is an instance of a template."""
        return self.template_id is not None
    
    def get_template(self):
        """Get the template this block is based on."""
        if self.template_id:
