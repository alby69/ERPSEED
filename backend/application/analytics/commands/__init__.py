"""
Analytics Commands - Command classes for Charts and Libraries.
"""
...
class CreateChartCommand(CreateCommand):
    project_id: int = 0; name: str = ""; chart_type: str = ""; config: Dict[str, Any] = None; model_id: Optional[int] = None
    
    def __post_init__(self):
        if self.config is None: self.config = {}
    
    def to_payload(self) -> Dict[str, Any]:
        return {"project_id": self.project_id, "name": self.name, "chart_type": self.chart_type, "config": self.config, "model_id": self.model_id}
...
class UpdateChartCommand(UpdateCommand):
    name: Optional[str] = None; chart_type: Optional[str] = None; config: Optional[Dict[str, Any]] = None
...
class CreateChartLibraryCommand(CreateCommand):
    library_name: str = ""; display_name: str = ""; description: str = ""; is_default: bool = False
    is_active: bool = True; config: Dict[str, Any] = None
...
class UpdateChartLibraryCommand(UpdateCommand):
    library_name: Optional[str] = None; display_name: Optional[str] = None; description: Optional[str] = None
    is_default: Optional[bool] = None; is_active: Optional[bool] = None; config: Optional[Dict[str, Any]] = None
