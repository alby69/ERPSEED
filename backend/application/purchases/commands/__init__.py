"""
Purchases Commands - Command classes for Purchases.
"""
...
class CreatePurchaseOrderCommand(CreateCommand):
    number: str = ""; date: str = ""; supplier_id: int = 0; expected_date: str = ""; notes: str = ""
...
class UpdatePurchaseOrderCommand(UpdateCommand):
    number: Optional[str] = None; date: Optional[str] = None; supplier_id: Optional[int] = None
    status: Optional[str] = None; expected_date: Optional[str] = None; notes: Optional[str] = None
...
class ListPurchaseOrdersCommand(QueryCommand):
    search: str = ""; status: str = ""; supplier_id: Optional[int] = None
