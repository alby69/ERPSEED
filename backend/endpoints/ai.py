...
from backend.application.ai import (
    SendMessageCommand,
...
class AIChat(MethodView):
    ...
    def post(self, args):
        ...
        try:
            ...
            from backend.application.ai import SendMessageHandler
            from backend.application.ai.commands import SendMessageCommand
...
class AIGenerate(MethodView):
    ...
    def post(self, args):
        ...
        try:
            ...
            from backend.application.ai import GenerateConfigHandler
            from backend.application.ai.commands import GenerateConfigCommand
...
class AIConversation(MethodView):
    ...
    def get(self, conversation_id):
        ...
        try:
            from backend.application.ai import GetConversationHandler
            from backend.application.ai.queries import GetConversationQuery
...
class AITools(MethodView):
    ...
    def get(self):
        ...
        try:
            from backend.application.ai import GetToolDefinitionsHandler
            from backend.application.ai.queries import GetToolDefinitionsQuery
